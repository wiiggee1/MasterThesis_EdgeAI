...
pub const LP_I2C0 = extern struct {
    ...
    FIFO_CONF: mmio.Mmio(packed struct(u32) {
        /// Configures the water mark threshold of RXFIFO in nonfifo access mode. When reg_reg_fifo_prt_en is 1 and rx FIFO counter is bigger than reg_rxfifo_wm_thrhd[3:0], reg_rxfifo_wm_int_raw bit will be valid.
        RXFIFO_WM_THRHD: u4,
        reserved5: u1 = 0,
        /// Configures the water mark threshold of TXFIFO in nonfifo access mode. When reg_reg_fifo_prt_en is 1 and tx FIFO counter is smaller than reg_txfifo_wm_thrhd[3:0], reg_txfifo_wm_int_raw bit will be valid.
        TXFIFO_WM_THRHD: u4,
        reserved10: u1 = 0,
